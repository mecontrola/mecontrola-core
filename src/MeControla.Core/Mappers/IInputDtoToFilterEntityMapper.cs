...
/// to objects of type <typeparamref name="TResult"/>, which implement <see cref="IFilterEntity"/>.
/// </summary>
/// <typeparam name="TParam">The source type that implements <see cref="IInputDto"/> to be mapped from.</typeparam>
/// <typeparam name="TResult">The destination type that implements <see cref="IFilterEntity"/> to be mapped to.</typeparam>
