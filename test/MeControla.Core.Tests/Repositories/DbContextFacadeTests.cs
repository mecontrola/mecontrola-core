...
namespace MeControla.Core.Tests.Repositories
{
    public class DbContextFacadeTests : BaseRepository
    {
        ...
        [Fact(DisplayName = "[DbContextFacade.AutoTransactionsEnabled] Deve retornar o mesmo valor que a instancia original.")]
        public void DeveGerarAutoTransactionsEnabled()
        {
#pragma warning disable CS0618 // Type or member is obsolete
            dbContextFacade.AutoTransactionsEnabled = false;

            dbContextFacade.AutoTransactionsEnabled
                           .Should()
                           .Be(databaseFacade.AutoTransactionsEnabled);
