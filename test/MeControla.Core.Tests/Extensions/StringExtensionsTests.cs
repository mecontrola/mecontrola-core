...
public class StringExtensionsTests
{
    ...
    [Fact(DisplayName = "[StringExtensions.Format] Deve formatar corretamente uma string com argumentos.")]
    public void DeveFormatarStringComArgumentos()
    {
        // Arrange
        string template = "Olá, {0}!";
        object[] args = { "Mundo" };
    ...
    [Fact(DisplayName = "[StringExtensions.Format] Deve lançar ArgumentNullException quando a string de template estiver vazia.")]
    public void DeveLancarArgumentNullExceptionQuandoTemplateVazio()
    {
        var template = string.Empty;
        object[] args = { "Mundo" };

        Action act = () => template.Format(args);

        act.Should().Throw<ArgumentNullException>()
           .WithMessage("Template string cannot be null or empty. (Parameter 'value')");
    }

    [Fact(DisplayName = "[StringExtensions.Format] Deve lançar ArgumentNullException quando a string de template for nula.")]
    public void DeveLancarArgumentNullExceptionQuandoTemplateNulo()
    {
    ...
    [Fact(DisplayName = "[StringExtensions.Format] Deve retornar a string original quando não há argumentos.")]
    ...
    [Fact(DisplayName = "[StringExtensions.Format] Deve formatar corretamente uma string com múltiplos argumentos.")]
    public void DeveFormatarStringComMultiplosArgumentos()
    {
        var template = "{0} é {1} anos.";
        object[] args = { "Alice", 30 };
        var expected = "Alice é 30 anos.";
